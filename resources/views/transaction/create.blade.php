		...
		<div class="card mb-4">
			<div class="card-body">
				<form action="{{ url('transaction') }}" method="post">
					@csrf
					<input type="hidden" name="book_id" value="{{ old('book_id') }}">
        			...
        			<div class="form-group">
						...
						<input type="text" name="book" class="form-control" value="{{ old('book') }}" readonly style="border-radius: 0%;">
        			</div> 
        			<div class="form-group">
    					<label class="control-label">Member <a href="#" data-toggle="modal" data-target="#modalMember"><em>choose</em></a></label>
						<input type="text" name="member" class="form-control" value="{{ old('member') }}" readonly style="border-radius: 0%;">
        			</div> 
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
